...
N 580 -450 580 -420 {lab=sw}
N 370 -450 580 -450 {lab=sw}
N 370 -260 370 -160 {lab=sw}
N 370 -160 390 -160 {lab=sw}
N 370 -260 390 -260 {lab=sw}
N 370 -450 370 -260 {lab=sw}
N 340 -260 370 -260 {lab=sw}
N 340 -370 510 -370 {lab=a}
...
C {iopin.sym} 340 -370 0 1 {name=p1 lab=a}
C {iopin.sym} 340 -260 0 1 {name=p3 lab=sw
}
C {iopin.sym} 340 -490 2 0 {name=p4 lab=VDD}
C {iopin.sym} 900 -370 0 0 {name=p5 lab=b}
