...
N 160 -1200 200 -1200 {lab=uio_in[7]}
N 160 -1180 200 -1180 {lab=uio_in[6]}
N 160 -1160 200 -1160 {lab=uio_in[5]}
N 160 -1140 200 -1140 {lab=uio_in[4]}
N 160 -1120 200 -1120 {lab=uio_in[3]}
N 160 -1100 200 -1100 {lab=uio_in[2]}
N 160 -1080 200 -1080 {lab=uio_in[1]}
N 160 -1060 200 -1060 {lab=uio_in[0]}
N 160 -1020 200 -1020 {lab=ui_in[7]}
N 160 -1000 200 -1000 {lab=ui_in[6]}
N 160 -980 200 -980 {lab=ui_in[5]}
N 160 -960 200 -960 {lab=ui_in[4]}
N 160 -940 200 -940 {lab=ui_in[3]}
N 160 -920 200 -920 {lab=ui_in[2]}
N 160 -900 200 -900 {lab=ui_in[1]}
N 160 -880 200 -880 {lab=ui_in[0]}
N 160 -840 200 -840 {lab=uio_oe[7]}
N 160 -820 200 -820 {lab=uio_oe[6]}
N 160 -800 200 -800 {lab=uio_oe[5]}
N 160 -780 200 -780 {lab=uio_oe[4]}
N 160 -760 200 -760 {lab=uio_oe[3]}
N 160 -740 200 -740 {lab=uio_oe[2]}
N 160 -720 200 -720 {lab=uio_oe[1]}
N 160 -700 200 -700 {lab=uio_oe[0]}
N 160 -660 200 -660 {lab=uio_out[7]}
N 160 -640 200 -640 {lab=uio_out[6]}
N 160 -620 200 -620 {lab=uio_out[5]}
N 160 -600 200 -600 {lab=uio_out[4]}
N 160 -580 200 -580 {lab=uio_out[3]}
N 160 -560 200 -560 {lab=uio_out[2]}
N 160 -540 200 -540 {lab=uio_out[1]}
N 160 -520 200 -520 {lab=uio_out[0]}
N 160 -480 200 -480 {lab=uo_out[7]}
N 160 -460 200 -460 {lab=uo_out[6]}
N 160 -440 200 -440 {lab=uo_out[5]}
N 160 -420 200 -420 {lab=uo_out[4]}
N 160 -400 200 -400 {lab=uo_out[3]}
N 160 -380 200 -380 {lab=uo_out[2]}
N 160 -360 200 -360 {lab=uo_out[1]}
N 160 -340 200 -340 {lab=uo_out[0]}
N 160 -1340 200 -1340 {lab=VAPWR}
N 160 -1320 200 -1320 {lab=VGND}
N 160 -1360 200 -1360 {lab=VPWR}
...
C {devices/ipin.sym} 160 -1240 2 1 {name=p32 lab=ena}
C {devices/ipin.sym} 160 -1200 2 1 {name=p33 lab=uio_in[7]}
C {conn_3x1.sym} 220 -1260 0 1 {name=c3 footprint=connector(3,1)}
C {conn_8x1.sym} 220 -1180 0 1 {name=c4 footprint=connector(8,1)}
C {devices/ipin.sym} 160 -1020 2 1 {name=p3 lab=ui_in[7]}
C {conn_8x1.sym} 220 -1000 0 1 {name=c5 footprint=connector(8,1)}
C {devices/opin.sym} 160 -840 2 0 {name=p18 lab=uio_oe[7]}
C {devices/opin.sym} 160 -820 2 0 {name=p27 lab=uio_oe[6]}
C {devices/opin.sym} 160 -800 2 0 {name=p28 lab=uio_oe[5]}
C {devices/opin.sym} 160 -780 2 0 {name=p29 lab=uio_oe[4]}
C {devices/opin.sym} 160 -760 2 0 {name=p41 lab=uio_oe[3]}
C {devices/opin.sym} 160 -740 2 0 {name=p42 lab=uio_oe[2]}
C {devices/opin.sym} 160 -720 2 0 {name=p43 lab=uio_oe[1]}
C {devices/opin.sym} 160 -700 2 0 {name=p44 lab=uio_oe[0]}
C {conn_8x1.sym} 220 -820 0 1 {name=c6 footprint=connector(8,1)}
C {devices/opin.sym} 160 -660 2 0 {name=p45 lab=uio_out[7]}
C {devices/opin.sym} 160 -640 2 0 {name=p46 lab=uio_out[6]}
C {devices/opin.sym} 160 -620 2 0 {name=p47 lab=uio_out[5]}
C {devices/opin.sym} 160 -600 2 0 {name=p48 lab=uio_out[4]}
C {devices/opin.sym} 160 -580 2 0 {name=p49 lab=uio_out[3]}
C {devices/opin.sym} 160 -560 2 0 {name=p50 lab=uio_out[2]}
C {devices/opin.sym} 160 -540 2 0 {name=p51 lab=uio_out[1]}
C {devices/opin.sym} 160 -520 2 0 {name=p52 lab=uio_out[0]}
C {conn_8x1.sym} 220 -640 0 1 {name=c7 footprint=connector(8,1)}
C {devices/opin.sym} 160 -480 2 0 {name=p53 lab=uo_out[7]}
C {devices/opin.sym} 160 -460 2 0 {name=p54 lab=uo_out[6]}
C {devices/opin.sym} 160 -440 2 0 {name=p55 lab=uo_out[5]}
C {devices/opin.sym} 160 -420 2 0 {name=p56 lab=uo_out[4]}
C {devices/opin.sym} 160 -400 2 0 {name=p57 lab=uo_out[3]}
C {devices/opin.sym} 160 -380 2 0 {name=p58 lab=uo_out[2]}
C {devices/opin.sym} 160 -360 2 0 {name=p59 lab=uo_out[1]}
C {devices/opin.sym} 160 -340 2 0 {name=p60 lab=uo_out[0]}
C {conn_8x1.sym} 220 -460 0 1 {name=c8 footprint=connector(8,1)}
C {conn_3x1.sym} 220 -1340 0 1 {name=c9 footprint=connector(3,1)}
C {devices/iopin.sym} 160 -1360 2 0 {name=p4 lab=VPWR}
C {devices/iopin.sym} 160 -1320 2 0 {name=p9 lab=VGND}
C {devices/iopin.sym} 160 -1340 2 0 {name=p12 lab=VAPWR}
C {devices/ipin.sym} 160 -1000 2 1 {name=p13 lab=ui_in[6]}
C {devices/ipin.sym} 160 -980 2 1 {name=p14 lab=ui_in[5]}
C {devices/ipin.sym} 160 -960 2 1 {name=p15 lab=ui_in[4]}
C {devices/ipin.sym} 160 -940 2 1 {name=p16 lab=ui_in[3]}
C {devices/ipin.sym} 160 -920 2 1 {name=p17 lab=ui_in[2]}
C {devices/ipin.sym} 160 -900 2 1 {name=p25 lab=ui_in[1]}
C {devices/ipin.sym} 160 -880 2 1 {name=p26 lab=ui_in[0]}
C {devices/ipin.sym} 160 -1180 2 1 {name=p34 lab=uio_in[6]}
C {devices/ipin.sym} 160 -1160 2 1 {name=p35 lab=uio_in[5]}
C {devices/ipin.sym} 160 -1140 2 1 {name=p36 lab=uio_in[4]}
C {devices/ipin.sym} 160 -1120 2 1 {name=p37 lab=uio_in[3]}
C {devices/ipin.sym} 160 -1100 2 1 {name=p38 lab=uio_in[2]}
C {devices/ipin.sym} 160 -1080 2 1 {name=p39 lab=uio_in[1]}
C {devices/ipin.sym} 160 -1060 2 1 {name=p40 lab=uio_in[0]}
C {conn_3x1.sym} 220 -280 0 1 {name=c10 footprint=connector(3,1)}
